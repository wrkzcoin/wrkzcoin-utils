    ...
    class KeyPair {
        ...
        static from(publicKey, privateKey, entropy, iterations, createEmpty = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (publicKey && (yield Types_1.WrkzCoinCrypto.checkKey(publicKey))) {
                    pair.m_publicKey = publicKey;
                }
                if (privateKey && (yield Types_1.WrkzCoinCrypto.checkScalar(privateKey))) {
                ...
                if (pair.m_privateKey && !pair.m_publicKey) {
                    ...
                    if (iterations && iterations === 1) {
                        const temp = yield Types_1.WrkzCoinCrypto.cn_fast_hash(pair.m_privateKey);
                        yield pair.setPrivateKey(temp);
                    }
                    pair.m_publicKey = yield Types_1.WrkzCoinCrypto.secretKeyToPublicKey(pair.m_privateKey);
                }
                return pair;
            });
        }
        ...
        setPrivateKey(key) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    this.m_privateKey = (yield Types_1.WrkzCoinCrypto.checkScalar(key))
                        ? key : yield Types_1.WrkzCoinCrypto.scReduce32(key);
                }
                catch (e) {
        ...
        setPublicKey(key) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    isPubKey = yield Types_1.WrkzCoinCrypto.checkKey(key);
                }
                catch (e) {
        ...
        isPaired() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return ((yield Types_1.WrkzCoinCrypto.secretKeyToPublicKey(this.privateKey)) === this.publicKey);
            });
        }
    }
...
function simpleKdf(value, iterations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < iterations; i++) {
            hex = yield Types_1.WrkzCoinCrypto.cn_fast_hash(hex);
        }
        return hex;
    });
}
