 ...
 */
class LegacyWrkz extends HTTPClient_1.HTTPClient {
    /**
    ...
    fee() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                amount: big_integer_1.default(response.amount)
            };
        });
    }
    /**
    ...
    block(block) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = {
                alreadyGeneratedCoins: big_integer_1.default(response.alreadyGeneratedCoins),
    ...
    _poolChanges(tailBlockHash, knownTransactionHashes = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tx of tmp) {
                tx.prefix.unlock_time = big_integer_1.default(tx.prefix.unlock_time);
            }
    ...
    _transaction(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            response.tx.unlock_time = big_integer_1.default(response.tx.unlock_time);
            return response;
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const block of response.items) {
                ...
                for (const txn of block.transactions) {
                    txn.unlockTime = big_integer_1.default(txn.unlockTime);
                }
            }
            return response;
        });
