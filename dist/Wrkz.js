 ...
 */
class Wrkz extends HTTPClient_1.HTTPClient {
    /**
    ...
    fee() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            response.amount = big_integer_1.default(response.amount);
            return response;
        });
    }
    /**
    ...
    block(block) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            response.alreadyGeneratedCoins = big_integer_1.default(response.alreadyGeneratedCoins);
    ...
    blockHeaders(height) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of response) {
                item.alreadyGeneratedCoins = big_integer_1.default(item.alreadyGeneratedCoins);
    ...
    transaction(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            response.block.alreadyGeneratedCoins = big_integer_1.default(response.block.alreadyGeneratedCoins);
            response.block.timestamp = new Date(response.block.timestamp * 1000);
            response.prefix.unlockTime = big_integer_1.default(response.prefix.unlockTime);
            return response;
        });
    }
    /**
    ...
    sync(checkpoints = [], height = 0, timestamp = 0, skipCoinbaseTransactions = false, count = 100) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            response.blocks = response.blocks.map((block) => {
                if (block.coinbaseTX) {
                    block.coinbaseTX.unlockTime = big_integer_1.default(block.coinbaseTX.unlockTime);
                }
                block.transactions = block.transactions.map(tx => {
                    tx.unlockTime = big_integer_1.default(tx.unlockTime);
                    return tx;
                });
                return block;
            });
