...
class Transaction {
    ...
    hash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.WrkzCoinCrypto.cn_fast_hash(this.m_cached.blob);
            if (this.version >= 2) {
                const hash2 = yield Types_1.WrkzCoinCrypto.cn_fast_hash(hash + TransactionVersion2Suffix);
    ...
    prefixHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.WrkzCoinCrypto.cn_fast_hash(this.m_cached.prefix);
            if (this.version >= 2) {
                const hash2 = yield Types_1.WrkzCoinCrypto.cn_fast_hash(hash + TransactionVersion2Suffix);
    ...
    parseExtra(extra) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.publicKey && (yield Types_1.WrkzCoinCrypto.checkKey(this.publicKey))) {
    ...
    generateTxProofOfWork(diff) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nonce = yield Types_1.WrkzCoinCrypto.generateTransactionPow(prefix, unserializedOffset, diff);
