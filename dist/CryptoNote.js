...
class CryptoNote {
    ...
    constructor(config, cryptoConfig) {
        ...
        if (cryptoConfig) {
            Types_1.WrkzCoinCrypto.userCryptoFunctions = cryptoConfig;
        }
    }
    /**
     ...
     */
    get cryptoConfig() {
        return Types_1.WrkzCoinCrypto.userCryptoFunctions;
    }
    set cryptoConfig(config) {
        Types_1.WrkzCoinCrypto.userCryptoFunctions = config;
    }
    /**
    ...
    generateKeyDerivation(transactionPublicKey, privateViewKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return Types_1.WrkzCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
        });
    }
    /**
    ...
    generateKeyImage(transactionPublicKey, privateViewKey, publicSpendKey, privateSpendKey, outputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            const derivation = yield Types_1.WrkzCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
    ...
    generateKeyImagePrimitive(publicSpendKey, privateSpendKey, outputIndex, derivation) {
        return __awaiter(this, void 0, void 0, function* () {
            const publicEphemeral = yield Types_1.WrkzCoinCrypto.derivePublicKey(derivation, outputIndex, publicSpendKey);
            const privateEphemeral = yield Types_1.WrkzCoinCrypto.deriveSecretKey(derivation, outputIndex, privateSpendKey);
            const keyImage = yield Types_1.WrkzCoinCrypto.generateKeyImage(publicEphemeral, privateEphemeral);
            return {
    ...
    privateKeyToPublicKey(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return Types_1.WrkzCoinCrypto.secretKeyToPublicKey(privateKey);
        });
    }
    /**
    ...
    isOurTransactionOutput(transactionPublicKey, output, privateViewKey, publicSpendKey, privateSpendKey, generatePartial) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const derivedKey = yield Types_1.WrkzCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
                const publicEphemeral = yield Types_1.WrkzCoinCrypto.derivePublicKey(derivedKey, output.index, publicSpendKey);
                if (publicEphemeral === output.key) {
                    ...
                    if (privateSpendKey) {
                        ...
                        const privateEphemeral = (generatePartial)
                            ? privateSpendKey
                            : yield Types_1.WrkzCoinCrypto.deriveSecretKey(derivedKey, output.index, privateSpendKey);
                        const derivedPublicEphemeral = yield Types_1.WrkzCoinCrypto.secretKeyToPublicKey(privateEphemeral);
    ...
    formatMoney(amount) {
        ...
        return numeral_1.default(amount / Math.pow(10, this.m_config.coinUnitPlaces || Config_1.Config.coinUnitPlaces)).format('0,0.' + places);
    }
    /**
    ...
    signMessage(message, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const publicKey = yield Types_1.WrkzCoinCrypto.secretKeyToPublicKey(privateKey);
            const hex = Buffer.from(message);
            const hash = yield Types_1.WrkzCoinCrypto.cn_fast_hash(hex.toString('hex'));
            return Types_1.WrkzCoinCrypto.generateSignature(hash, publicKey, privateKey);
        });
    }
    /**
    ...
    verifyMessageSignature(message, publicKey, signature) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hex = Buffer.from(message);
            const hash = yield Types_1.WrkzCoinCrypto.cn_fast_hash(hex.toString('hex'));
            return Types_1.WrkzCoinCrypto.checkSignature(hash, publicKey, signature);
        });
    }
    /**
    ...
    createTransactionStructure(outputs, inputs, randomOutputs, mixin, feeAmount, paymentId, unlockTime, extraData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (feeAmount < Config_1.Config.FeeNoTxPoW) {
...
function checkRingSignatures(hash, keyImage, publicKeys, signatures) {
    return __awaiter(this, void 0, void 0, function* () {
        return Types_1.WrkzCoinCrypto.checkRingSignatures(hash, keyImage, publicKeys, signatures);
    });
}
/** @ignore */
function generateRingSignatures(hash, keyImage, publicKeys, privateKey, realOutputIndex, index) {
    return __awaiter(this, void 0, void 0, function* () {
        const signatures = yield Types_1.WrkzCoinCrypto.generateRingSignatures(hash, keyImage, publicKeys, privateKey, realOutputIndex);
...
function prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex, derivation, outputIndex, index, tx_public_key, randomKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const prepped = yield Types_1.WrkzCoinCrypto.prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex, randomKey);
        return {
            index: index,
...
function completeRingSignatures(privateSpendKey, derivation, outputIndex, realOutputIndex, key, sigs, index) {
    return __awaiter(this, void 0, void 0, function* () {
        const privateEphemeral = yield Types_1.WrkzCoinCrypto.deriveSecretKey(derivation, outputIndex, privateSpendKey);
        const signatures = yield Types_1.WrkzCoinCrypto.completeRingSignatures(privateEphemeral, realOutputIndex, key, sigs);
        return { signatures, index };
    });
}
/** @ignore */
...
function prepareTransactionOutputs(outputs) {
    return __awaiter(this, void 0, void 0, function* () {
        function prepareOutput(destination, amount, index, privateKey) {
            return __awaiter(this, void 0, void 0, function* () {
                const outDerivation = yield Types_1.WrkzCoinCrypto.generateKeyDerivation(destination.view.publicKey, privateKey);
                const outPublicEphemeral = yield Types_1.WrkzCoinCrypto.derivePublicKey(outDerivation, index, destination.spend.publicKey);
                return {
                    amount,
        ...
        const keys = yield Types_1.WrkzCoinCrypto.generateKeys();
